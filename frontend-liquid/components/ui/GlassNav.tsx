  ...
  return (
    <>
      <motion.nav
        ...
        className="sticky top-4 z-50 mx-4 md:mx-auto max-w-6xl rounded-2xl glass-mask shadow-[inset_0_1px_rgba(255,255,255,0.06)] bg-bg-surface backdrop-blur-[40px] backdrop-saturate-[180%] px-6 py-4 flex items-center justify-between gap-6"
      >
        <div className="flex-1 shrink-0">
          <Link
            href="/"
            className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-accent-purple to-accent-green pr-4"
          >
            KG + GNN
          </Link>
        </div>
